        ...
        {products.map((product) => (
          <div key={product.id} className="px-2 sm:px-4 focus:outline-none">
            <div className="group relative bg-[#F5F5F5] rounded-md aspect-square flex items-center justify-center p-6 overflow-hidden">
              ...
              <button 
                disabled={isAdding}
                className="absolute bottom-0 w-full bg-black sm:hidden text-white py-2 opacity-100 group-hover:opacity-100 transition-opacity duration-300 disabled:bg-gray-600 disabled:cursor-not-allowed active:bg-gray-800"
